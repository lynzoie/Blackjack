...
REM
REM Generated by Vivado on Fri Mar 03 22:19:27 -0600 2023
...
echo "xvlog --incr --relax -prj tb_blackjack_vlog.prj"
call xvlog  --incr --relax -prj tb_blackjack_vlog.prj -log xvlog.log
